...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed=42, fcs1_units=512, fc2_units=256, fc3_units=128):
        ...
        self.__seed = torch.manual_seed(seed)
        self.__fcs1 = nn.Linear(state_size, fcs1_units)
        self.__fc2  = nn.Linear(fcs1_units + action_size, fc2_units)
        self.__fc3  = nn.Linear(fc2_units, fc3_units)
        self.__out  = nn.Linear(fc3_units, 1)
    ...
    def reset_parameters(self):
        ...
        self.__fc2.weight.data.uniform_(*utils.hidden_layer_param_initializer(self.__fc2))
        self.__fc3.weight.data.uniform_(*utils.hidden_layer_param_initializer(self.__fc3))
        self.__out.weight.data.uniform_(-3e-3, 3e-3)
